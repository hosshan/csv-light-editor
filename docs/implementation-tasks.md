...
#### タスク2.6: カラム操作機能（Phase 2実装済み）
- [x] 列の追加（指定位置）
- [x] 列の削除
- [x] 列名の変更

#### タスク2.7: 行操作機能（Phase 2実装済み）
- [x] 行の追加（指定位置）
- [x] 行の削除
- [x] 行の複製

#### タスク2.8: データ型検出と検証（Phase 2実装済み）
- [x] データ型自動検出（Integer, Float, Boolean, Date, DateTime, Email, URL, JSON, Text）
- [x] カラムごとのデータ型判定
- [x] データ型に基づくバリデーション
- [x] エラーレポート生成

#### タスク2.9: 検索・置換機能（Phase 2実装済み）
- [x] テキスト検索
- [x] 大文字小文字の区別オプション
- [x] 完全一致検索
- [x] 正規表現サポート
...
#### タスク2.10: インポート/エクスポート設定（Phase 2実装済み）
- [x] 設定の永続化
- [x] デフォルト設定管理
- [x] エンコーディング設定
- [x] デリミタ設定
...
#### タスク3.4: 行操作（Phase 2で完了）
- [x] 行の追加（上/下）
- [x] 行の削除
- [ ] 行の移動（ドラッグ＆ドロップ）
- [x] 行の複製

#### タスク3.5: 列操作（Phase 2で完了）
- [x] 列名の変更
- [x] 列の追加（左/右）
- [x] 列の削除
- [ ] 列の移動
